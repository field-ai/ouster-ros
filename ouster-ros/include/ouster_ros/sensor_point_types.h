...
// Profile_RNG19_RFL8_SIG16_NIR16_RGB16 aka single return RGB
...
struct Point_RNG19_RFL8_SIG16_NIR16_RGB16 : public _Point_RNG19_RFL8_SIG16_NIR16_RGB16 {

    inline Point_RNG19_RFL8_SIG16_NIR16_RGB16(const _Point_RNG19_RFL8_SIG16_NIR16_RGB16& pt)
    {
      x = pt.x; y = pt.y; z = pt.z; data[3] = 1.0f;
      t = pt.t; ring = pt.ring;
      range = pt.range; signal = pt.signal;
      reflectivity = pt.reflectivity; flags = pt.flags;
      near_ir = pt.near_ir;
    ...
    inline Point_RNG19_RFL8_SIG16_NIR16_RGB16()
    {
      ...
      t = 0; ring = 0;
      range = 0; signal = 0;
      reflectivity = 0; flags = 0; near_ir = 0;
      r = 0; g = 0; b = 0;
    }

    inline const auto as_tuple() const {
        return std::tie(x, y, z, t, ring, range, signal, reflectivity, flags, near_ir);
    }
...
// Profile_RNG19_RFL8_SIG16_NIR16_RGB16_DUAL aka dual return RGB
static constexpr ChanFieldTable<6> Profile_RNG19_RFL8_SIG16_NIR16_RGB16_DUAL{{
    {ChanField::RANGE, ChanFieldType::UINT32},
    {ChanField::SIGNAL, ChanFieldType::UINT16},
    {ChanField::REFLECTIVITY, ChanFieldType::UINT8},
    {ChanField::NEAR_IR, ChanFieldType::UINT16},
...
static constexpr ChanFieldTable<6> Profile_RNG19_RFL8_SIG16_NIR16_RGB16_DUAL_2ND_RETURN{{
    {ChanField::RANGE2, ChanFieldType::UINT32},
    {ChanField::SIGNAL2, ChanFieldType::UINT16},
    {ChanField::REFLECTIVITY2, ChanFieldType::UINT8},
    {ChanField::NEAR_IR, ChanFieldType::UINT16},
...
struct Point_RNG19_RFL8_SIG16_NIR16_RGB16_DUAL : public _Point_RNG19_RFL8_SIG16_NIR16_RGB16_DUAL {

    inline Point_RNG19_RFL8_SIG16_NIR16_RGB16_DUAL(const _Point_RNG19_RFL8_SIG16_NIR16_RGB16_DUAL& pt)
    {
      x = pt.x; y = pt.y; z = pt.z; data[3] = 1.0f;
      t = pt.t; ring = pt.ring;
      range = pt.range; signal = pt.signal;
